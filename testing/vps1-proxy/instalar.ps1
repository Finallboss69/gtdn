# ============================================================
#  GUARD_GO - Instalador VPS1 (38.54.45.154)
...
Write-Host "=== Instalando GUARD_GO en VPS1 ===" -ForegroundColor Cyan
...
Write-Host "  VERIFICACION COMPLETA - VPS1" -ForegroundColor Cyan
Write-Host "=============================================" -ForegroundColor Cyan
